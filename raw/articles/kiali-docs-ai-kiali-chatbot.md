---
source_url: https://kiali.io/docs/ai/kiali-chatbot/
ingested: 2026-09-17
sha256: 866d95b984ee0ac747f63aad975201a4725cdcbdc0897f3d28f7e75a371bde2b
---
...
The Kiali Chatbot is disabled by default. To enable it, set `ai.enabled: true` and `ai.chat.enabled: true`. When enabled, you will see the chatbot icon in the Kiali UI:
...
To see the available built-in tool names you can use in these lists, see [Kiali Chatbot tools](/docs/ai/kiali-chatbot-tools/).
...
If you want to use an AI assistant outside the Kiali UI (for example, in an IDE), see [Kiali MCP](/docs/ai/kiali-mcp/).
